...
export const ROWS = [
  { type: 'option', key: 'twitStyle', title: '트윗 성향', options: TWIT_STYLE_OPTIONS, otherSmall: true },
  { type: 'option', key: 'mainFocus', title: '주력', options: MAIN_FOCUS_OPTIONS, otherSmall: true },
  { type: 'option', key: 'couple', title: '커플 성향', options: COUPLE_OPTIONS, otherSmall: true },
  { type: 'option', key: 'fubFree', title: 'FUB FREE', options: FUB_FREE_OPTIONS, radioOptions: ['OK', 'X'] },
  { type: 'option', key: 'breakup', title: '이별 시', options: BREAKUP_OPTIONS, otherSmall: true },
  { type: 'option', key: 'dislike', title: '불호', options: DISLIKE_OPTIONS, otherSmall: true },
...
export const RIGHT_SECTION_X_barx1 = RIGHT_SECTION_X + 160
export const RIGHT_SECTION_X_barx2 = RIGHT_SECTION_X_barx1 + 425
